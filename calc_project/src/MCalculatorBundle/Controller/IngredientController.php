...
use MCalculatorBundle\Entity\Ingredient;
...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $ingredients = $em->getRepository('MCalculatorBundle:Ingredient')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('MCalculatorBundle\Form\IngredientType', $ingredient);
    ...
    {
        $deleteForm = $this->createDeleteForm($ingredient);
        $editForm = $this->createForm('MCalculatorBundle\Form\IngredientType', $ingredient);
    ...
    public function findIngredient(Ingredient $ingredient)
    {
